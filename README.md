...
```bash
git clone https://github.com/pheleex/AirBnB_clone.git
```

## How to run the command interpreter
Change to the `AirBnb` directory and run the following command:
...
## AUTHORS
* **Felix Anyanwu** - [pheleex](https://github.com/pheleex)
